...
public class WakeGroupWidgetConfigure extends FragmentActivity {
    ...
    public void configureWidget(Context context) {
        ...
        WakeGroupWidget.updateAppWidget(context, appWidgetManager, this.mAppWidgetId);
    }
    ...
    private void onDialogResponse(Group choice) {
        ...
        prefs.edit().putLong(WakeGroupWidget.PREFERENCES_TAG + this.mAppWidgetId, choice.getId()).commit();
