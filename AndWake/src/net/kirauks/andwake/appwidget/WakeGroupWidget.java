...
public class WakeGroupWidget extends AppWidgetProvider {
    ...
    private static Group getTarget(Context context, int appWidgetId) {
        ...
        final List<Group> groups = db.getGroupDataSource().getGroups(new long[]
            { targetId });
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.appwidget_wake_group);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            WakeGroupWidget.updateAppWidget(context, appWidgetManager, appWidgetId);
        }
    }
}
