...
public class ConfigureComputerDialogFragment extends ConfigureDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.appwidget_computer_dialog_config_title).setItems(computersNames.toArray(new String[computersNames.size()]), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (ConfigureComputerDialogFragment.this.configureListener != null) {
                    ConfigureComputerDialogFragment.this.configureListener.onConfigureComputer(computers.get(which));
                }
            }
        });
