...
public class WakeComputerWidget extends AppWidgetProvider {
    ...
    private static Computer getTarget(Context context, int appWidgetId) {
        ...
        final List<Computer> computers = db.getComputerDataSource().getComputers(new long[]
            { targetId });
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.appwidget_wake_computer);
        ...
        views.setOnClickPendingIntent(R.id.appwidget_computer_wake, pendingIntent);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            WakeComputerWidget.updateAppWidget(context, appWidgetManager, appWidgetId);
        }
    }
}
