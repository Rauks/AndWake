...
public class GroupsFragment extends ListFragment {
	public class GroupsAdapter extends ArrayAdapter<Group> {
		public class GroupComputersAdapter extends ArrayAdapter<Computer> {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				View rootView = inflater.inflate(
						R.layout.list_element_group_computer, parent, false);

				TextView name = (TextView) rootView
						.findViewById(R.id.list_element_group_computer_name);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			LayoutInflater inflater = ((Activity) this.getContext())
					.getLayoutInflater();
			View rootView = inflater.inflate(R.layout.list_element_group,
					parent, false);

			TextView name = (TextView) rootView
					.findViewById(R.id.list_element_group_name);
			LinearLayout computers = (LinearLayout) rootView
					.findViewById(R.id.list_element_group_computers);

			name.setText(item.getName());
			GroupComputersAdapter adapter = new GroupComputersAdapter(
					this.getContext(), item.getChildren());
			...
			Button wake = (Button) rootView
					.findViewById(R.id.list_element_group_wake);
