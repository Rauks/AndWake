...
public class ComputerDeleteDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this.getActivity()).setTitle(R.string.dialog_delete_computer_title).setIcon(R.drawable.ic_dialog_discard).setView(inflater.inflate(R.layout.dialog_fragment_delete_computer, null)).setPositiveButton(R.string.dialog_ok, new OnClickListener() {
            @Override
